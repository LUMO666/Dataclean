#!/usr/bin/env python3
"""Thin entry: discover → ManualGate → shared phase orchestrator."""
...
ENGINE_SRC = DATACLEAN_ROOT / "engine"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Dataclean phases for this dataset package")
